...
| **TB1** | 23/04/2025 | Todo el equipo FlowStack           | Participamos del desarrollo colaborativo del Sprint 1, incluyendo planificación, ejecución de tareas técnicas, validación de criterios de aceptación, despliegue de la Landing Page y recopilación de evidencias para revisión de sprint.             |
| **TP1** | 03/05/2025 | Joaquín Alonso Carbajal Pozzo     | Trabajé en la implementación de los Core Entities Unit Tests, asegurando que las entidades clave de Managewise pasaran las pruebas unitarias, lo cual es fundamental para garantizar que cada componente funcione correctamente. |
| **TP1** | 02/05/2025 | Joaquin David Rivadeneyra Ramos   | Colaboré en los Core Integration Tests, verificando la correcta interacción entre las distintas partes del sistema para asegurar que los módulos se integraran sin problemas. |
| **TP1** | 01/05/2025 | Nelson Elías Serrano Ircañaupa    | Me encargué de desarrollar los Core Behavior-Driven Development (BDD), definiendo el comportamiento esperado del sistema desde la perspectiva del usuario y asegurando que cumpliera con las expectativas. |
| **TP1** | 13/05/2025 | Sergio André Gómez Vallejos       | Trabajé en la implementación de las prácticas de Continuous Integration, asegurando que cada cambio realizado en el código fuera probado automáticamente y validado antes de integrarse a la rama principal. |
| **TP1** | 12/05/2025 | Diego Miguel Ramirez Ortega       | Me ocupé de las Build & Test Suite Pipeline Components, creando una pipeline para automatizar la construcción, integración y pruebas del código, asegurando así un proceso de desarrollo ágil y libre de errores. |
| **TP1** | 15/05/2025 | Todo el equipo FlowStack           | El equipo trabajó de manera colaborativa en la implementación de Continuous Delivery, configurando las herramientas necesarias para la entrega continua y garantizando que las versiones del producto llegaran rápidamente a producción sin fallos. |
| **TB2** | 10/06/2025 | Joaquín Alonso Carbajal Pozzo     | Implementé los **Core Unit Tests** para la integración de nuevas entidades y validación de datos, mejorando la calidad del código y la cobertura de pruebas. |
| **TB2** | 11/06/2025 | Joaquin David Rivadeneyra Ramos   | Colaboré en los **Core Integration Tests**, asegurando la correcta interacción entre módulos y validando que las funcionalidades trabajen de manera conjunta sin errores. |
| **TB2** | 12/06/2025 | Nelson Elías Serrano Ircañaupa    | Desarrollé los **Core Behavior-Driven Development (BDD)**, definiendo el comportamiento esperado del sistema desde la perspectiva del usuario, asegurando la alineación con los requisitos del producto. |
| **TB2** | 14/06/2025 | Sergio André Gómez Vallejos       | Trabajé en la integración de **Continuous Integration**, mejorando la automatización del ciclo de pruebas y validaciones al integrar nuevas funcionalidades de manera continua y eficiente. |
| **TB2** | 16/06/2025 | Diego Miguel Ramirez Ortega       | Me encargué de las **Build & Test Suite Pipeline Components**, creando y optimizando pipelines para garantizar una integración continua y pruebas automatizadas eficientes. |
| **TB2** | 18/06/2025 | Josue Omar Hidalgo Bustamante     | Implementé pruebas para el **Backend Serverless API** y validación de la interacción con **APIs externas**, asegurando que el sistema funcione correctamente bajo diversas condiciones. |
...
| **Orden** | **User Story ID** | **Título**                                  | **Story Points** (1 / 2 / 3 / 5) |
|-----------|-------------------|---------------------------------------------|--------------------------------|
| 1         | UA01              | Gestión de Progreso de Tareas               | 5                              |
| 2         | UA02              | Visualización de Backlog de Tareas          | 3                              |
| 3         | UA03              | Acceso a Tareas Pendientes                  | 2                              |
| 4         | UA04              | Gestión de Recursos del Equipo              | 5                              |
| 5         | UA05              | Optimización de Notificaciones en Tiempo Real | 3                              |
| 6         | UA06              | Gestión de Accesos y Permisos               | 5                              |
| 7         | UA07              | Creación de Tareas de Alto Impacto          | 3                              |
| 8         | UA08              | Gestión de Sprint en el Timeline            | 5                              |
| 9         | UA09              | Reportes de Actividad                       | 2                              |
| 10        | UA10              | Integración con Herramientas de Comunicación | 3                              |
